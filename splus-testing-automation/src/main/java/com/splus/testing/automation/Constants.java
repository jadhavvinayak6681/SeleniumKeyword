...
{
	public static String FILE_NAME = "C:\\Selenium\\Data\\S+SeleniumFramework\\RobustData.xls";
	public static String APPLICATION_SHEET = "Application";
	public static String _PASS = "Pass";
	public static String _FAIL = "Fail";
	public static String _PASSFAIL = "Fail";
	...
	public static String CYCLE_ID="0001511769584449-242ac112-0001";
}
