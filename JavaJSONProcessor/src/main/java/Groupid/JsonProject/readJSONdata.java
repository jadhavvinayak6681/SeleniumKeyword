...
import com.thed.zapi.cloud.sample.sampleJwtGenerator;

public class readJSONdata 
{
	private static final String filePath = "C:\\Users\\rohit.labhe\\git\\Cucumber_Automation\\ThirdCucumberProject\\cucumberCallingSmoke\\target\\cucumberNew.json";
	static int ii = 0;
	public static JSONObject createjsonObject = new JSONObject();
	public static JSONObject statusJsonObj = new JSONObject();
	static Object[] arrayJson = new Object[3]; 
	...
	public static void createnewJSONfile() throws IOException, URISyntaxException
	{
		Object[] getjsondata = new Object[3];
		createjsonObject.accumulate("status", statusJsonObj);
		getjsondata = sampleJwtGenerator.getExecution("PROJ2" , "PROJ2-1");
		createjsonObject.put("projectId",getjsondata[0]);
		createjsonObject.put("issueId", getjsondata[1]);
		System.out.println(getjsondata[2]);
		getjsonfields((String) getjsondata[2],(String) getjsondata[3]);
		createjsonObject.put("cycleId",arrayJson[1]);
		createjsonObject.put("versionId",arrayJson[0]);
        ...
        FileWriter fileWriter = new FileWriter("D:\\processedJSON.json");
        ...
        sampleJwtGenerator.putTestResult("PROJ2" , "PROJ2-1");
